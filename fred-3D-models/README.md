## FRED and Frida - 3D parts

Figure 1 shows the 3D models of FRED rendered in TinkerCad. Item (1) shows the 3D part of FRED's head. Item (2) shows the cover of the back of the head. Item (3) is the robot's thorax. The version in the image is equivalent to the thorax of the female version made to receive the pink heart). Item (4) shows the cover of the back of the thorax. Item (5) shows the shoulder that must be screwed to the thorax. Items (6) and (7) are, respectively, the arm and the articulated hand of the robot. There is no difference between the left and right arms and hands. Items (8) and (9) are the right and left feet. It is important to note that there is a difference between the left and right foot models. In (10) you can see two pieces of the robot's legs. These pieces use the same model, with no difference between the left and right legs. In (11) you can see the model of FRED's glasses. And finally, in item (12) you can see the model of the female glasses and the 3D heart piece that can be fitted to the female chest model.
